...
IDM_LESS_LIGHT   equ 206
IDM_MORE_LIGHT   equ 207 
IDM_BWSTYLE      equ 208
IDM_MIRROR_V     equ 209
IDM_MIRROR_H     equ 210
IDM_ROTATE_LEFT  equ 211
IDM_ROTATE_RIGHT equ 212
...
WndProcMain proc hwnd:HWND, iMsg:UINT, wParam:WPARAM, lParam:LPARAM
    ...
    .elseif [iMsg] == WM_COMMAND
        ...
        .elseif word ptr [wParam] == IDM_LESS_LIGHT
            .if [glCurrentBitmap]
                invoke GetUpdateLightBitmap, [glCurrentBitmap], 0
                mov newBitmap, eax
                invoke UpdateCurrentBitmap, [newBitmap], [hwnd]
            .endif
        .elseif word ptr [wParam] == IDM_MORE_LIGHT
            .if [glCurrentBitmap]
                invoke GetUpdateLightBitmap, [glCurrentBitmap], 1
                mov newBitmap, eax
                invoke UpdateCurrentBitmap, [newBitmap], [hwnd]
            .endif

        .elseif word ptr [wParam] == IDM_BWSTYLE
            .if [glCurrentBitmap]
                invoke GetBlackWhiteStyleBimap, [glCurrentBitmap]
                mov newBitmap, eax
                invoke UpdateCurrentBitmap, [newBitmap], [hwnd]
            .endif

        .elseif word ptr [wParam] == IDM_MIRROR_V
            .if [glCurrentBitmap]
                invoke MirrorBitmapV, [glCurrentBitmap]
                mov newBitmap, eax
                invoke UpdateCurrentBitmap, [newBitmap], [hwnd]
            .endif
        .elseif word ptr [wParam] == IDM_MIRROR_H
            .if [glCurrentBitmap]
                invoke MirrorBitmapH, [glCurrentBitmap]
                mov newBitmap, eax
                invoke UpdateCurrentBitmap, [newBitmap], [hwnd]
            .endif
        .elseif word ptr [wParam] == IDM_ROTATE_LEFT
            .if [glCurrentBitmap]
                invoke RotateLeft90, [glCurrentBitmap]
                mov newBitmap, eax
                invoke UpdateCurrentBitmap, [newBitmap], [hwnd]
            .endif
        .elseif word ptr [wParam] == IDM_ROTATE_RIGHT
            .if [glCurrentBitmap]
                invoke RotateRight90, [glCurrentBitmap]
                mov newBitmap, eax
                invoke UpdateCurrentBitmap, [newBitmap], [hwnd]
            .endif
