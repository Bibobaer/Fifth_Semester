...
CreateChessWindow proc hIns:HINSTANCE, parent:HWND, color:COLORREF, x:dword, y:dword, ftype: FIGTYPE
    ...
    mov [eax].ChessWindowStruct.isCapture, FALSE
...
GetChessCenter proc hwnd:HWND, x:ptr dword, y:ptr dword
    ...
    add [point].x, CHESS_CENTER

    mov eax, [rect].top
    mov [point].y, eax

    add [point].y, CHESS_CENTER
...
WndProcChess proc stdcall hwnd:HWND, iMsg:UINT, wParam:WPARAM, lParam:LPARAM
    ...
    .elseif [iMsg] == WM_LBUTTONDOWN
        ...
        mov eax, [cws]
        mov [eax].ChessWindowStruct.isCapture, TRUE
    ...
    .elseif [iMsg] == WM_LBUTTONUP
        ...
        mov eax, [center_x]
        mov [current_cords], eax
        mov eax, [center_y] 
        mov [current_cords+4], eax
        
        invoke SendMessage, edx, WM_CHESS_CENTER, [hwnd], addr current_cords
        
        mov eax, [current_cords]
        mov [center_x], eax
        mov eax, [current_cords+4]
        mov [center_y], eax
    ...
    .elseif [iMsg] == WM_MOUSEMOVE
        mov eax, [cws]
        .if [wParam] & MK_LBUTTON && [eax].ChessWindowStruct.isCapture == TRUE
